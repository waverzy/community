...
function createNormalMenu(callback) {
    ...
    subMenu31.type = "view";
    subMenu31.name = "绑定";
    subMenu31.url = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=" + utils.getAppid() + "&redirect_uri=http://wx.zhiertech.com/index/index&response_type=code&scope=snsapi_base#wechat_redirect";
    var subMenu32 = {};
    subMenu32.type = "view";
    subMenu32.name = "绑定";
    subMenu32.url = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=" + utils.getAppid() + "&redirect_uri=http://wx.zhiertech.com/adminLogin&response_type=code&scope=snsapi_base#wechat_redirect";
    var menu3 = {};
    menu3.name = "个人中心";
    menu3.sub_button = [subMenu31, subMenu32];
    var button = {};
...
function createNeighborMenu(callback) {
    var menu1 = {};
    menu1.type = "click";
    menu1.name = "惬意生活";
    menu1.key = "M1";
    ...
    var menu3 = {};
    menu3.name = "个人中心";
    menu3.sub_button = [subMenu31, subMenu32, subMenu33];
    var button = {};
    button.button = [menu1, menu2, menu3];
    var matchrule = {};
    matchrule.tag_id = "111";
