...
function createNormalMenu(callback) {
    ...
    subMenu32.type = "view";
    subMenu32.name = "绑定";
    subMenu32.url = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=" + utils.getAppid() + "&redirect_uri=http://wx.zhiertech.com/review&response_type=code&scope=snsapi_base#wechat_redirect";
    var menu3 = {};
    menu3.name = "个人中心";
