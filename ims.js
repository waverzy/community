...
function createNormalMenu(callback) {
    ...
    subMenu31.type = "view";
    subMenu31.name = "绑定";
    subMenu31.url = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=" + utils.getAppid() + "&redirect_uri=http://wx.zhiertech.com/index&response_type=code&scope=snsapi_base#wechat_redirect";
    var subMenu32 = {};
    subMenu32.type = "view";
    subMenu32.name = "绑定";
